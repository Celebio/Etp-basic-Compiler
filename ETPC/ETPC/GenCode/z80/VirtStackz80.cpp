...
int VirtStackz80::GetStackPos(char* VarNom)
{
	...
	return -77777;	// magic number pour dire qu'il n'a pas trouvé alors qu'il est censé
					// le trouver car les vérifications sont faites dans verisem
}
